...
export default function ProductCard({ product }: { product: Product }) {
  ...
  const msg = encodeURIComponent(`Je veux commander : ${product.nom} — ${product.prix}`);
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex gap-2">
          <a
            href={product.lienYoucan}
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-black py-3 rounded-xl text-sm text-center transition-all hover:shadow-lg hover:shadow-orange-100"
          >
            Commander
          </a>
          <a
